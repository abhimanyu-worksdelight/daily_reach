class ArchievModel {
  ...
  ArchievModel({this.status, this.data, this.message});

  ArchievModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <ArchievData>[];
      json['data'].forEach((v) {
        data!.add(new ArchievData.fromJson(v));
      });
    }
...
class ArchievData {
  ...
  ArchievData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
    body = json['body'];
